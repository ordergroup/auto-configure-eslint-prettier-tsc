...
// const prettierIgnore = `build node_modules README.md .next out`
...
const installDependencies = async () => {
  const answers = await inquirer.prompt([
    {
      ...
      message: 'Do you want to install ESLint @8.57.0, prettier @2.8.0, typescript @5.4.5 @react-native/eslint-config @0.74.84 @tsconfig/react-native @3.0.5?',
      default: true,
    },
  ]);
  ...
  if (answers.installDependencies) {
    try {
      ...
      execSync('yarn add eslint@^8.57.0 prettier@^2.8.0 typescript@^5.4.5 @react-native/eslint-config@^0.74.84 @tsconfig/react-native@^3.0.5 --dev', { stdio: 'inherit' });
